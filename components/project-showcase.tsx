  ...
  infrastructure: [
    {
      ...
      demoUrl: "https://network-dashboard.pages.dev/#/login",
      githubUrl: "#",
      icon: TrendingUp,
    },
    {
      ...
      description: "Automated cloud workflows and infrastructure management",
      stack: ["AWS", "Terraform", "Docker", "React"],
      features: ["Automated deployment", "Infrastructure as Code", "Multi-cloud support"],
      outcome: "Reduced migration time by 60%",
      demoUrl: "https://f52b449c.cloud-migration.pages.dev/",
      githubUrl: "#",
      icon: TrendingUp,
    },
    {
      ...
      demoUrl: "https://2cfce982.iotmanager.pages.dev/login/",
      githubUrl: "#",
      icon: Shield,
    },
    {
      ...
      demoUrl: "https://predictive-maintenance.pages.dev/",
      githubUrl: "#",
      icon: TrendingUp,
    },
  ],
  ai: [
    {
      ...
      demoUrl: "https://aisupport.pages.dev/",
      githubUrl: "#",
      icon: Bot,
      hasLiveDemo: true,
    },
    {
      ...
      demoUrl: "https://security-threat-detection.pages.dev/",
      githubUrl: "#",
      icon: Shield,
    },
    {
      ...
      demoUrl: "https://data-graphs.pages.dev/",
      githubUrl: "#",
      icon: TrendingUp,
    },
  ],
  web: [
    {
      ...
      demoUrl: "https://financial-dash.pages.dev/",
      githubUrl: "#",
      icon: TrendingUp,
    },
    {
      ...
      demoUrl: "https://url-shorter-3ct.pages.dev/login/",
      githubUrl: "#",
      icon: ExternalLink,
    },
    {
      ...
      demoUrl: "https://video-converter-bg8.pages.dev/",
      githubUrl: "#",
      icon: Play,
    },
  ],
  blockchain: [
    {
      ...
      demoUrl: "https://wepay-crypto.pages.dev/",
      githubUrl: "#",
      icon: Shield,
    },
    {
      ...
      demoUrl: "https://iot-dash.pages.dev/",
      githubUrl: "#",
      icon: Smartphone,
      hasLiveDemo: true,
    },
